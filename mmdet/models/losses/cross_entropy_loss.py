...
def re_binary_cross_entropy(pred,
                         label,
...
def r_binary_cross_entropy(pred,
                         label,
                         reverse_focal_rate,
                         margin_factor,
                         weight=None,
...
class CrossEntropyLoss(nn.Module):
    ...
    def __init__(self,
        ...
        if self.use_sigmoid:
            self.cls_criterion = binary_cross_entropy #True
        elif self.use_mask:
...
@LOSSES.register_module()
class ReCrossEntropyLoss(nn.Module):
    ...
    def __init__(self,
        ...
        Args:
            ...
            loss_weight (float, optional): Weight of the loss. Defaults to 1.0.
        """
        super(ReCrossEntropyLoss, self).__init__()
        assert (use_sigmoid is False) or (use_mask is False)
        self.use_sigmoid = use_sigmoid
        self.use_mask = use_mask
        self.reduction = reduction
        ...
        if self.use_sigmoid: #True
            self.cls_criterion = re_binary_cross_entropy
        elif self.use_mask:
            self.cls_criterion = mask_cross_entropy
        else:
            self.cls_criterion = cross_entropy
...
@LOSSES.register_module()
class RCrossEntropyLoss(nn.Module):
    ...
    def __init__(self,
        ...
        Args:
            ...
            loss_weight (float, optional): Weight of the loss. Defaults to 1.0.
        """
        super(RCrossEntropyLoss, self).__init__()
        assert (use_sigmoid is False) or (use_mask is False)
        self.use_sigmoid = use_sigmoid
        self.use_mask = use_mask
        self.reduction = reduction
        ...
        if self.use_sigmoid: #True
            self.cls_criterion = r_binary_cross_entropy
        elif self.use_mask:
            self.cls_criterion = mask_cross_entropy
        else:
            self.cls_criterion = cross_entropy
