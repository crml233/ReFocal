...
class ReRPNHead(AnchorHead):
    ...
    def _get_targets_single(self,
        ...
        # map up to original set of anchors，填充 anchor 到没有筛选 valid flag 的长度
        if unmap_outputs: #True 是否将输出映射回原始 anchor 配置
    ...
    def loss_single(self, anchors,cls_score, bbox_pred,  labels, label_weights,
                    bbox_targets, bbox_weights, pos_preds_gt, pos_num_gt, num_total_samples):
