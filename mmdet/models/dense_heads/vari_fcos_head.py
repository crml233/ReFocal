...
class Vari_FCOSHead(AnchorFreeHead):
    ...
    def loss(self,
        ...
        if num_pos > 0:
            #最初版本没有用3000，即target一直是iou， bbox一直是none！
            #p2跑的是全是iou的19.2
            #目前还原最初版本
            ...
            if self.vfl:
                ...
                cls_iou_targets[pos_inds, pos_labels] = pos_ious#pos_targets #pos_ious
        else:
