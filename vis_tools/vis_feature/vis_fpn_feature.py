...
# config_file='/home/czj/mmdet-rfla/configs/baselines/aitodv2_fcos_r50_1x.py'
...
# 测试单张图片并生成推理结果 
# imgpath = '/home/czj/mmdet-rfla/vis_tools/vis_feature/img_demo/P2689__1.0__1200___600.png' 
...
dpath = '/home/czj/mmdet-rfla/vis_tools/vis_feature/fpn_show/fcos_llefpn'
...
# _ = model(inputs=img.cuda(),mode='predict')#,mode="predict"，p2，p3，p4
...
for i in range(lenth):
    ...
    cv2.imwrite(name+'_{}.jpg'.format(wide), heatmap)
